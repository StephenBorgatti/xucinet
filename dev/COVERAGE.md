...
Generated by `dev/make-coverage.R` on 24 September 2026. Do not edit by hand.
...
| coded, goldens pending | written and tested; the golden tests skip until the UCINET batch is run | 58 |
| not started | no function yet | 12 |
...
| section | topic | UCINET | 2.0 function | status |
|---|---|---|---|---|
| 13.2 / 13.3 | Two-mode to one-mode (affiliations), incl. valued/normalized variants | Data\|Affiliations (2-mode to 1-mode) | `xaffiliations()` | coded, goldens pending |
| 13.4 | Two-mode to bipartite | Transform\|Graph Theoretic\|Bipartite | `xbipartite()` | coded, goldens pending |
| 13.5 | Bi-cliques | (command language) biclique() | `xbicliques()` | coded, goldens pending |
