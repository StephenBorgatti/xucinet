...
Generated by `dev/make-coverage.R` on 26 September 2026. Do not edit by hand.
...
| 11.4.1 | QuickClus (3e only) | Network\|Communities/Subgroups\|QuickClus | - | dropped |
| 11.4.2 | Louvain | Network\|Communities/Subgroups\|Louvain Method | `xlouvain()` | coded, goldens pending |
| 11.4.2 (ASNR) | Walktrap (ASNR only; not in 3e) | (none) | - | dropped |
...
| section | topic | UCINET | 2.0 function | status |
|---|---|---|---|---|
| 15.x | ERGMs | (none — 3e ch 15 already uses R: statnet/ergm) | - | dropped |
...
- QuickClus: the crosswalk marks it for dropping; chapter 11 does not use it
- Walktrap: design question 11.5 (after D-7); the third edition does not use it, and the 1e aliases name xcommunities()
- ERGMs: decision D-9; chapter 15 uses statnet's ergm and RSiena directly, with as_network() as the bridge, so there are no xucinet wrappers
